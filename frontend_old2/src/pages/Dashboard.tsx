...
//  Funciona apenas com APIs de notas
// ==========================================
...
import { Plus, Edit, Trash2, StickyNote, Search, X } from "lucide-react";
...
const Dashboard = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingNote) {
        await notesAPI.update(Number(editingNote.id), title, content);
  ...
  const handleDelete = async (note: Note) => {
    ...
    try {
      await notesAPI.delete(Number(note.id));
                ...
                <DialogHeader>
                  ...
                  <DialogDescription>
                    {editingNote
                      ...
                      : "Preencha para criar uma nova nota."}
                  </DialogDescription>
                </DialogHeader>
